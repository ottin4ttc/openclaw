...
function resolvePluginToolRegistry(params: {
  ...
  // across a multi-owner request would split hook and tool closure state.
  ...
  // Reuse the Gateway-owned registrations first. Their factories accept
  // request context directly; reloading them would replace initialized hooks
  // with fresh service closures that were never started.
