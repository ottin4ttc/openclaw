...
| `nativeHookRelay.enabled`                     | `true`                                                 | Controls only the OpenClaw compatibility relay for Codex-native tool and finalization hooks. Set `false` to avoid injecting OpenClaw relay commands; Codex-owned user and plugin hooks remain enabled.                                                                                                                                                                                          |
