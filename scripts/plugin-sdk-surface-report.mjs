...
const defaultPublicDeprecatedExportsByEntrypointBudget = Object.freeze({
  ...
  // +2: trusted diagnostic content-capture contracts reflected through the deprecated type barrel.
  "infra-runtime": 597,
  "ssrf-policy": 1,
  "ssrf-runtime": 1,
  "media-runtime": 2,
...
export function readPluginSdkSurfaceBudgets(env = process.env) {
  const budgets = {
    ...
    publicDeprecatedExports: readPluginSdkSurfaceBudgetEnv(
      ...
      // +4: trusted diagnostic listener/capture contracts mirrored by deprecated barrels.
      3009,
      env,
    ),
