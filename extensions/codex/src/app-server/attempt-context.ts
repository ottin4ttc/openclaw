...
export function renderCodexSkillsCollaborationInstructions(params: {
  ...
  return params.skillsPrompt?.trim()
    ? [
        "## OpenClaw Skills",
        "",
        "The <location> values below are filesystem paths in the current execution environment.",
        "Read them with the available filesystem or command tools; do not pass these paths to the native skills.read tool.",
        "",
